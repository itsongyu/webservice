...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://weather/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://weather/", "queryWeatherResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weather/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weather/", name = "queryWeatherResponse")

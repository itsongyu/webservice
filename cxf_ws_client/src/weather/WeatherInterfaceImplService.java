...
public class WeatherInterfaceImplService extends Service {
    ...
    public final static QName SERVICE = new QName("http://weather/", "WeatherInterfaceImplService");
    public final static QName WeatherInterfaceImplPort = new QName("http://weather/", "WeatherInterfaceImplPort");
    static {
        URL url = null;
        try {
